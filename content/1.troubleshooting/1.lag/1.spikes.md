...
#### \[Windows-only] Prevent your OS from rapidly disabling and re-enabling your network adapter
Toggle off [Wireless Adapter Power Savings](/miscellaneous/other/wireless-adapter-power-savings) if you use any Windows OS.
