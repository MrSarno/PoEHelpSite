...
#### Ensure the game isn't running on your CPU's integrated graphics (Desktop-only)
...
#### If using a laptop, configure Windows to run Path of Exile using your more powerful video card
